...
try {
	...
	String[][] listfinal = new String [4000][18];
	double score[]=new double [4800];
	int count=0;
File excel1 = new File ("D:\\US_Padhai\\InputToCompare.xls");
File excel2 = new File ("D:\\US_Padhai\\Record.xls");
File file =new File ("D:\\Experiment\\2.txt");
PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("D:\\US_Padhai\\Fraud_LINKS.txt", true)));
